...
const signup = async (req, res, next)=>{
    ...
    res.status(201).json({ user : createdUser._id, email : createdUser.email, author : createdUser.name ,token : token ,message : "User created Successfully!!"});
};
...
const login = async (req, res, next)=>{
    ...
    res.json({ user : identifiedUser._id, email : identifiedUser.email, author : identifiedUser.name ,token : token, message : "Logged In"});
};
